...
activities = {
    ...
    "Fencing Club": {
        "description": "Develop fencing skills with foil and epee training",
    ...
    "Reading Club": {
        "description": "Discuss books, improve reading comprehension, and share recommendations",
    ...
    "Clay Sculpting": {
        "description": "Create ceramic sculptures and learn hand-building techniques",
